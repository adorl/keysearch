...
/*
 * sha256_compress_avx512_soa_preloaded — SoA variant with pre-loaded message words.
 *
 ...
 * This eliminates the load_be32_16way gather+bswap overhead when the caller
 * can produce SoA words directly from SIMD field elements.
 */
__attribute__((target("avx512f")))
void sha256_compress_avx512_soa_preloaded(__m512i soa_state[8], const __m512i w_in[16])
{
    ...
    /* Use pre-loaded message words directly (no load_be32_16way) */
    __m512i w0 = w_in[0], w1 = w_in[1];
    __m512i w2 = w_in[2], w3 = w_in[3];
    __m512i w4 = w_in[4], w5 = w_in[5];
    __m512i w6 = w_in[6], w7 = w_in[7];
    __m512i w8 = w_in[8], w9 = w_in[9];
    __m512i w10 = w_in[10], w11 = w_in[11];
    __m512i w12 = w_in[12], w13 = w_in[13];
    __m512i w14 = w_in[14], w15 = w_in[15];
    ...
    /* Accumulate initial state and write back to SoA array */
    soa_state[0] = _mm512_add_epi32(a, a0);
    soa_state[1] = _mm512_add_epi32(b, b0);
    soa_state[2] = _mm512_add_epi32(c, c0);
    soa_state[3] = _mm512_add_epi32(d, d0);
